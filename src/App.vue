<template>
  <div id="app">
    <app-header v-if="show" class="header"/>
    <headerAuth v-if="!show" class="header"/>
...
button {
  ...
  font-size: 25px;
  border-radius: 8px;
  background-color: rgba(158, 150, 149, 0.4);
  margin-right: 10px;
}
button:hover {
...
.show-blogs-column  .single-blog{
  ...
  background: rgba(247, 238, 238, 0.774);
  width: 500px;
  height: 650px;
  border: 1px solid black
}
.show-blogs-column .single-blog .blogImage {
  max-width: 400px;
  max-height: 500px;
}
.show-blogs {
...
.single-blog{
  ...
  margin: 10px 0;
  box-sizing: border-box;
  background: rgba(247, 238, 238, 0.9);
  width: 300px;
  border: 1px solid black
}
.single-blog h2{
